...
{
  public:
    void init(VkDevice device, VkPhysicalDevice physicalDevice, VertexResourceManager& vertexResourceManager,
    ...
    VkImageView getShadowDepthImageView()
    {
    ...
    {
        return shadowCommandBuffers[index];
    }
