...
private:
    ...
    void createRenderPass() {
        ...
        renderPassInfo.pAttachments = renderPassInfo.pAttachments = attachments.data();
    ...
    void createGraphicsPipeline() {
        ...
        auto vertShaderModule = createShaderModule(vsmoduleCreateInfo);
        auto fragShaderModule = createShaderModule(fsmoduleCreateInfo);
